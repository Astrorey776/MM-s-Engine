...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const SphereA& sphere, float mass)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const CubeA& cube, float mass)
{
...
/*PhysSensor3D* ModulePhysics3D::AddSensor(const CubeA& cube, const vec3 gravityMod, const SensorType s_type, vec4 tarRot)
{
	btCollisionShape* colShape = new btBoxShape(btVector3(cube.size.x * 0.5f, cube.size.y * 0.5f, cube.size.z * 0.5f));
	shapes.add(colShape);
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const CylinderA& cylinder, float mass)
{
